...
var stringOutput = myBabelute._output('html:string');

// apply babelute on any dom node to decorate it (children and attributes)
if (typeof document !== 'undefined')
	myBabelute._output('html:dom', document.body);
...
var stringified = templ.stringify();
...
var r1 = templ && templ._output('html:string'),
	r2 = n && n._output('html:string');
